...
@section('page-title', 'Tambah Kriteria Penilaian')
@section('page-subtitle', 'Tambahkan kriteria penilaian praktik baru.')
                    ...
                    <form action="{{ route('admin.kriteria-penilaian.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" rows="3"
                                ...
                                placeholder="Deskripsi singkat kriteria">{{ old('description') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <div id="checklistContainer" class="mt-2">
                                @php $oldChecklist = old('sop_checklist', ['']); @endphp
                                @foreach($oldChecklist as $idx => $val)
                                    <div class="input-group mb-2 checklist-item">
                                        ...
                                        <input type="text" name="sop_checklist[]" value="{{ $val }}"
                                            class="form-control" placeholder="Contoh: Melakukan cuci tangan sebelum tindakan" required>
