...
<head>
    ...
    <meta name="description" content="@yield('description', 'Guru - LMS SMK Kesehatan Trimurti Husada')">
    ...
    :root {
        ...
        /* Keep for legacy views that reference these */
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    /* Legacy card/btn styles used by older views */
    .card { border: 1px solid var(--border-color); border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,.06); }
    .stats-card { background:#fff; border-radius:12px; padding:1.5rem; border:1px solid var(--border-color); height:100%; transition:all .3s; }
    ...
    <style>
    /* ── Guru theme overrides — Teal-Blue-Navy gradient ── */
    :root {
        --bg-page:    #f0f4f8;
        --brand-from: #0f766e;
        --brand-to:   #1d4ed8;
    ...
    /* Page header guru — teal gradient */
    .lms-page-header {
    ...
    .lms-page-header .btn-info {
        background: rgba(255,255,255,.95) !important;
        color: #0f766e !important; border: none !important;
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb bg-transparent p-0 mb-0">
                    <li class="breadcrumb-item">
                        <a href="{{ route('guru.dashboard') }}" class="text-decoration-none">Beranda</a>
                    </li>
                    @yield('breadcrumb')
                </ol>
            </nav>
