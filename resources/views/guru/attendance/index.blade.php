{{--
    Route guru.attendance.index → redirect ke guru.absensi.index
    File ini hanya sebagai alias routing; konten sebenarnya ada di guru/absensi/index.blade.php
    JANGAN gunakan @include di sini karena absensi/index juga @extends layouts.guru
--}}
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-center py-3">
        ...
        <span class="badge bg-secondary">
            {{ method_exists($attendances, 'total') ? $attendances->total() : $attendances->count() }} data
        </span>
    </div>
